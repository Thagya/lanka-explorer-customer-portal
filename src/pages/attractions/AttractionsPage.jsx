      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
        ...
        {userLocation ? (
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-teal-500 bg-teal-50 text-teal-600 text-sm font-medium whitespace-nowrap"
          >
            <LocateFixed size={15} className="text-teal-500" />
            Sorted by distance
            <X size={13} className="ml-1 opacity-60" />
          </button>
        ) : (
          <button
            onClick={requestLocation}
            disabled={geoLoading}
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-gray-200 bg-white text-gray-600 hover:border-teal-400 hover:text-teal-600 text-sm font-medium whitespace-nowrap transition-colors disabled:opacity-50"
          >
            <Navigation size={15} />
